...
import { WEEK_MS, weeklyPeriodFromDate, weeklyPeriodFromId, previousWeeklyPeriod, weeklyScopeFromPeriod } from "../core/weekly-core.mjs?v2442-weekly-payment-production";
