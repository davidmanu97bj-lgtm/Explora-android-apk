/* Compatibilidad validada: v2530-visual-textos-liquidar */
/* EXPLORA PWA service worker · v2.5.1 */
const CACHE_PREFIX = 'explora-pwa-';
const CACHE_NAME = `${CACHE_PREFIX}v2530-visual-textos-liquidar`;
const APP_SHELL = [
  './',
  './index.html',
  ...
  './css/segments/52-style.css?v=2530-visual-textos-liquidar',
  './js/segments/52-script.mjs?v=2530-visual-textos-liquidar',
...
/* cache bump: v2530 visual anterior textos liquidar */
