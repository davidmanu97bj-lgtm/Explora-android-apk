/* Compatibilidad validada: v3701-km-historial-orden-boton-neutro */
/* EXPLORA PWA service worker · v2.5.1 */
const CACHE_PREFIX = 'explora-pwa-';
const CACHE_NAME = `${CACHE_PREFIX}v3701-km-historial-orden-boton-neutro`;
const APP_SHELL = [
  './',
  './index.html',
  ...
  './css/segments/52-style.css?v=3701-km-historial-orden-boton-neutro',
  './js/segments/52-script.mjs?v=3701-km-historial-orden-boton-neutro',
...
/* cache bump: v3700 km historial cierres */
