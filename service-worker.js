/* Compatibilidad validada: v2528-detalles-plegables-resumen-anterior */
/* EXPLORA PWA service worker · v2.5.1 */
const CACHE_PREFIX = 'explora-pwa-';
const CACHE_NAME = `${CACHE_PREFIX}v2528-detalles-plegables-resumen-anterior`;
const APP_SHELL = [
  './',
  './index.html',
  ...
  './css/segments/52-style.css?v=2528-detalles-plegables-resumen-anterior',
  './js/segments/52-script.mjs?v=2528-detalles-plegables-resumen-anterior',
...
/* cache bump: v2527 resumen 50/50 anterior */
