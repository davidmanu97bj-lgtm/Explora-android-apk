/* Compatibilidad validada: v2701-cartel-amarillo-dinamico */
/* EXPLORA PWA service worker · v2.5.1 */
const CACHE_PREFIX = 'explora-pwa-';
const CACHE_NAME = `${CACHE_PREFIX}v2701-cartel-amarillo-dinamico`;
const APP_SHELL = [
  './',
  './index.html',
  ...
  './css/segments/52-style.css?v=2701-cartel-amarillo-dinamico',
  './js/segments/52-script.mjs?v=2701-cartel-amarillo-dinamico',
