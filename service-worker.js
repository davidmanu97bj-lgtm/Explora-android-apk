/* Compatibilidad validada: v2529-ui-dorado-billete */
/* EXPLORA PWA service worker · v2.5.1 */
const CACHE_PREFIX = 'explora-pwa-';
const CACHE_NAME = `${CACHE_PREFIX}v2529-ui-dorado-billete`;
const APP_SHELL = [
  './',
  './index.html',
  ...
  './css/segments/52-style.css?v=2529-ui-dorado-billete',
  './js/segments/52-script.mjs?v=2529-ui-dorado-billete',
...
/* cache bump: v2529 ui dorado premium billete */
