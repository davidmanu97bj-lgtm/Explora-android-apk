/* Compatibilidad validada: v2526-textos-cierre-anterior */
/* EXPLORA PWA service worker · v2.5.1 */
const CACHE_PREFIX = 'explora-pwa-';
const CACHE_NAME = `${CACHE_PREFIX}v2526-textos-cierre-anterior`;
const APP_SHELL = [
  './',
  './index.html',
  ...
  './css/segments/52-style.css?v=2526-textos-cierre-anterior',
  './js/segments/52-script.mjs?v=2526-textos-cierre-anterior',
